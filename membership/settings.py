...
DATABASES = {
    'default': {
        ...
        'NAME': './membership.sqlite3',          # Or path to database file if using sqlite3.
...
SECRET_KEY = 's$#7(8453m+50u+hrzp3o$1@7slak&amp;^$=ky48iv9w-j+g5i!2u'
...
TEMPLATE_CONTEXT_PROCESSORS = ("django.contrib.auth.context_processors.auth",
                               ...
                               "membership.views.context_processor")
